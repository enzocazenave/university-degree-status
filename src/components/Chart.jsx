...
import { getSubjectsTaking } from '../helpers/getSubjectsTaking';
...
export const Chart = () => {
	...
	const subjectsTaking = getSubjectsTaking()
	...
	return (
		<section className={styles.container}>
			...
			<span className={styles.chartSubjects}><span>{subjectsTaking}</span> materias en curso</span>
			...
			<span className={styles.chartSubjects}><span>{subjectsLength - subjectsTaken - subjectsTaking}</span> materias pendientes de cursar</span>
